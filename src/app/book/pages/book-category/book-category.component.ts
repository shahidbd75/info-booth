...
export class BookCategoryComponent implements OnInit, OnDestroy {
  ...
  constructor(private formBuilder: FormBuilder, private bookCategoryService: BookCategoryService, private router: Router,
  ...
  onSave() {
    ...
    this.subscription.add(this.bookCategoryService.save(requestModel).subscribe(()=> {
  ...
  onUpdate() {
    ...
    this.subscription.add(this.bookCategoryService.update(requestModel).subscribe(()=> {
      this.router.navigate(['book/book-categories']);
  ...
  loadData() {
    this.activatedRoute.params.subscribe((params: Params) => {
      ...
      if(id) {
        this.subscription.add(this.bookCategoryService.getById<BookCategoryResponseModel>(id).subscribe((data: BookCategoryResponseModel) => {
